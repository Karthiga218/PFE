...
class PFEClientInfoScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ClientName: "",
  ...
  static navigationOptions = () => ({
    headerTitle: (
      ...
      >
        <Text style={{ color: "white", fontSize: 20 }}>Client's Info</Text>
      </View>
    ),
    ...
    let children = (
      ...
      >
        <Picker
          ...
          itemStyle={{}}
          onValueChange={(itemValue, itemIndex) =>
            this.setState({ Borough: itemValue, showIOSPicker: false })
          }
        >
          <Picker.Item label="Bronx" value="Bronx" />
          <Picker.Item label="Brooklyn" value="Brooklyn" />
    ...
    return (
      ...
      >
        <View style={{ flex: 1, flexDirection: "column" }}>
          ...
          />
          <Overlay
            isVisible={this.state.showIOSPicker}
            animationType="slide"
            overlayStyle={{
              position: "absolute",
              bottom: 0,
          ...
          <Button
            ...
            disabled={
              this.state.ClientName.trim().length === 0 ||
...
const mapStateToProps = state => {
  return {
    ...
    Borough: state.PFEJobsReducer.Borough,
    ZipCode: state.PFEJobsReducer.ZipCode,
