...
import { createAppContainer, createStackNavigator, createBottomTabNavigator, navigationOptions } from 'react-navigation';
...
class DecalBarcodeReadScreen extends React.Component {
    // constructor(props){
    //     super(props)
    ...
    //       this.props.TurnOnOldDecalCamera();
...
export default connect(mapStateToProps, mapDispatchToProps)(DecalBarcodeReadScreen)