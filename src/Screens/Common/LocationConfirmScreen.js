...
class LocationConfirmScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
...
const mapStateToProps = state => {
  return {
    Latitude: state.RHJobsReducer.Location.Latitude,
    Longitude: state.RHJobsReducer.Location.Longitude,
    NearestAddress: state.RHJobsReducer.NearestAddress,
